...
roles = json.load(open('api/seed/data/user_types.csv'))
...
for role in roles:
    ...
    agencies = json.load(open('api/seed/data/agencies.csv'))
    ...
    projects = json.load(open('api/seed/data/projects.csv'))
    ...
    components = json.load(open('api/seed/data/components.csv'))
    ...
    proposals = json.load(open('api/seed/data/proposals.csv'))
    ...
    constraints = json.load(open('api/seed/data/constraints.csv'))
